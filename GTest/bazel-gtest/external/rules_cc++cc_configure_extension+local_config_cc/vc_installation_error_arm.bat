...
echo. 1>&2
echo Visual C++ build tools seems to be installed at C:\Program Files\Microsoft Visual Studio\2022\Community\VC 1>&2
echo But Bazel can't find the following tools: 1>&2
echo     cl.exe, dumpbin.exe, lib.exe, link.exe 1>&2
